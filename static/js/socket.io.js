	...
	Manager.prototype.reconnect = function () {
	  ...
	  if (this.backoff.attempts >= this._reconnectionAttempts) {
	    ...
	    var timer = setTimeout(function () {
	      ...
	      // check again for the case socket closed in above socket
	      if (self.skipReconnect) return;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Internal socket (blacklisted).
	 * These socket can't be emitted by the user.
	 *
	 * @api private
	 */
	...
	/**
	 * Subscribe to open, close and packet socket
	 *
	 * @api private
	 */
	...
	/**
	 * Override `emit`.
	 * If the event is in `socket`, it's emitted normally.
	 *
	...
	/**
	 * Emit buffered socket (received and emitted).
	 *
	 * @api private
	 */
